...
Hi! I’m **Erick**, a senior undergraduate student in **Data Science and Mathematics Engineering** at [Tecnológico de Monterrey](https://tec.mx/en), expecting to graduate in June 2026. My research journey is driven by the convergence of rigorous mathematical mehtods and the predictive power of computing and data. 
...
* **AI for Science:** Uncovering governing physical laws from data using methods like **Koopman Operator Theory (HAVOK)** and discovering how neural networks can model complex dynamical systems.
...
* **Mathematical Foundations of Learning:** Exploring the theoretical underpinnings of **Deep Learning** and **Machine Learning** to develop models that are not only accurate but mathematically rigorous and interpretable.
...
Currently, I am working as an **Advanced Analytics Intern at Crediclub**, where I engineer graph-based fraud detection pipelines using Neo4j and PySpark. Previously, I collaborated on research projects applying TDA to fuel price volatility (SLB) and optimization algorithms for reforestation (CONAFOR).

My professional philosophy is guided by the responsibility and purposeful application of knowledge, best captured by a quote that motivates my work:
